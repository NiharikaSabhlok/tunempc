...
b_add_noise = True
indices_for_adding_noise=[40,41,44,45]
noise_to_be_added=[0.1,0.1,0.5,0.3]
...
def main():
    ...
    for ridx in range(lo, hi + 1):
        ...
        outdir = OUT_ROOT / f"T_{t}_N_{n}_beta_{beta}_accreg_{accrg}_NMPC_{NSIM}_with_logs_and_noise_at_30"
        ensure_dir(outdir)
