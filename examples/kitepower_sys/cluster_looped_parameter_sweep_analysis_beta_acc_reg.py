...
windings=1
time_per_winding=25
intervals_per_winding = 50
N=int(intervals_per_winding * windings)
beta_0 = 0.1
acc_reg = 1
filefolder = '/pfs/data6/home/fr/fr_fr/fr_ns591/code/examples/parameter_sweep_analysis/beta_and_acc_reg_wide/'
file_name = 'Beta_and_acc_reg_sweep_wo_warmstarting'
ROOT = Path("/pfs/data6/home/fr/fr_fr/fr_ns591/code/examples/parameter_sweep_analysis/beta_and_acc_reg_wide")
CSV_PATH = ROOT/"BETA_AND_ACC_REGULARIZATION_SWEEP_WO_WARMSTARTING_RANGE_wide_final.csv"
options = {}
...
if TWO_PARAM_ANALYSIS :        
    ...
    for idy, beta_0 in enumerate([0, 0.01,0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5, 0.6,0.7,0.8,0.9,1,1.2,1.5]):
        for idx, acc_reg in enumerate([0,1,1e2, 5e3, 5e4, 5e5,1e6,3e6,5e6,8e6,1e7,3e7,5e7,8e7,1e8,5e8, 1e9, 5e9]):        
