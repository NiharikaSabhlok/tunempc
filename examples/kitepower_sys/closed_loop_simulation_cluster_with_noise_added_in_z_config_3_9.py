...
ROW_RANGE  = (16,17)              # inclusive (0-based): process rows 10..24 #299
...
array_of_percentage_of_traj = [0.4,0.8]
array_of_percentage_of_traj_np = np.array(array_of_percentage_of_traj, dtype=float)
noise_to_be_added=[0.2,0.7]
dz=10 # disturbance in position in z direction
