...
try:
    ...
    sys.exit(2)
PY
        #  looped_tuner_1.py looped_tuner_2.py looped_tuner_3.py looped_tuner_4.py looped_tuner_5.py \
        ...
        #  looped_tuner_25.py looped_tuner_26.p

for s in looped_tuner_19.py \
         looped_tuner_20.py looped_tuner_21.py looped_tuner_22.py \
         looped_tuner_23.py looped_tuner_24.py;
do
  sbatch -J "${s%.py}" -p cpu -t 60:00:00 -c 1 --mem=4G -o logs/%x_%j_mosek.out \
    --export=ALL \
    --wrap "
    set -euo pipefail;
    module purge; 
