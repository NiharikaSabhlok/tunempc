...
N=70
part=1
directory_path= "/pfs/data6/home/fr/fr_fr/fr_ns591/data/loop_T_35_N_70_test_1"
...
def tuner_convexification(pickle_file, beta, acc_reg, T, N):
    ...
    Hc,solver_status, equivalence_status = tuner.convexify(rho=2,force=True)
    S    = tuner.S
...
if __name__ == "__main__":
    ...
    OUT  = Path(f"test_tuner_cvxopt_convexification_results_wo_warmstarting_T_{T}_N_{N}_{part}.csv")
    run(ROOT, OUT)
