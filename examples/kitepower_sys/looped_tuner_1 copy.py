...
N=70
part=1
directory_path= "/pfs/data6/home/fr/fr_fr/fr_ns591/data/loop_T_35_N_70_te_1"
...
if __name__ == "__main__":
    ...
    OUT  = Path(f"tuner_cvxopt_convexification_results_wo_warmstarting_T_{T}_N_{N}_{part}.csv")
    run(ROOT, OUT)
